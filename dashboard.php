...
if ($user->isLoggedIn()) {
   if($user->data()->power == 1){
       ...
       $enrolled = $override->getCount1('clients', 'eligible', 1,'status', 1);
   }else{
       $screened = $override->countData('clients', 'status', 1,'site_id', $user->data()->site_id);
       $enrolled = $override->countData1('clients', 'eligible',1,'status', 1,'site_id', $user->data()->site_id);
   }
} else {
...
<head>
    <title> Dashboard - VolunteerDatabase</title>
