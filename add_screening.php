                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Conset ?</label>
                                                    <?php
                                                    $value = $override->get('yes_no', 'id', $screening['conset'])[0]  ?>
                                                    <select id="conset" name="conset" class="form-control" required>
                                                        <option value="<?= $value['id'] ?>"><?php if ($screening['conset']) {
                                                                                                print_r($value['name']);
                                                                                            } else {
                                                                                                echo 'select';
                                                                                            }  ?>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Screening Two Date</label>
                                                    <input type="date" class="form-control fas fa-calendar input-prefix" name="conset_date" id="conset_date" value="<?php if ($screening['conset_date']) {
