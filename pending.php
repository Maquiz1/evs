...
$numRec = 15;
$today = $override->getNo2News('visit', 'expected_date', date('Y-m-d'), 'status', 0, 'site_id', $user->data()->site_id);
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                $visit = $override->getNo2News('visit', 'expected_date', date('Y-m-d'), 'status', 0, 'site_id', $user->data()->site_id);
                                ?>
